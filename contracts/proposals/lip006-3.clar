...
(define-public (execute (sender principal))
	(let ((unminted-lqstx u223066680000)
			(amount-to-mint (contract-call? 'SM26NBC8SFHNW4P1Y4DFH27974P56WN86C92HPEHH.token-lqstx get-tokens-to-shares unminted-lqstx)))
